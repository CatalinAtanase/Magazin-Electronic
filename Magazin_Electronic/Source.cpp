...
void main() {
	...
	Frigider frigider("LG Door-in-Door", 1235, "LG", "Frigider practic", 100000, 12, false, false, 89, true, Culoare::gri, 4900, "A+++", 4, 401, true);
	Tv tv("Samsung OLED", 1234, "Samsung", "Super mega tv, calitate buna", 64500, 10, true, true, 12.57, true, Culoare::roz, 13000, "A++", 41, "LCD", "1080x1920");
	...
	while (input != 0) {
			...
			while (input != 0) {
				...
				if (input == 1) {
					...
					case 1:
						...
						controller.addProductToShop(produseDisponibile, new Telefon());
						break;
					case 2:
						controller.addProductToShop(produseDisponibile, new Tv());
						break;
					case 3:
						controller.addProductToShop(produseDisponibile, new Frigider());
						break;
					default:
						break;
					}
		...
		input = controller.chooseInput(0, 1);
	}
